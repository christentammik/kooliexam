# Define your Active Directory details
$domain = "oige.local"
$kasutajadOU = "OU=Kasutajad,DC=oige,DC=local"
$defaultPassword = "Parool123!"

# Function to remove special characters (Estonian diacritics)
...
# Function to generate a unique username and UPN
...
# Function to create an AD user if it doesn't exist
